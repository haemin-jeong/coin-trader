...
public class OrderServiceImpl implements OrderService {
    ...
    @Transactional
    public Order ask(Wallet wallet, Double tradePrice, LocalDateTime candleDatetime) {
        ...
        return orderRepository.save(askingOrder);
    }

    @Transactional
    public Order bid(Wallet wallet, Double tradePrice, LocalDateTime candleDateTime) {
        ...
        return orderRepository.save(biddingOrder);
    }
